...
@Component({
  selector: 'app-venta-producto-detalle-tailwind',
  templateUrl: './venta-producto-detalle-tailwind.component.html',
  styleUrls: ['./venta-producto-detalle-tailwind.component.css']
})
export class VentaProductoDetalleTailwindComponent implements OnInit{
